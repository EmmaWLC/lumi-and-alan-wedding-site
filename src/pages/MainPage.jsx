...
function MainPage() {
    ...
    return (
        <div className="main-page">
            ...
            {/* Our Story Card */}
            <FadeIn>
                <a href="https://gothic-mold-31003876.figma.site/our-story" className="link-card our-story-card" rel="noopener noreferrer">
                    <div
            ...
            {/* The Details Card */}
            <FadeIn>
                <a href="https://gothic-mold-31003876.figma.site/details" className="link-card details-card" rel="noopener noreferrer">
